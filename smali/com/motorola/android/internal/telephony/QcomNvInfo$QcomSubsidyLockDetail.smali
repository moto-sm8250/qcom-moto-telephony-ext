...
.method public static deserialize([B)Lcom/motorola/android/internal/telephony/QcomNvInfo$QcomSubsidyLockDetail;
    ...
    :cond_5
    :goto_1
    iget-object v0, v4, Lcom/motorola/android/internal/telephony/QcomNvInfo$QcomSubsidyLockDetail;->subtypeInfoList:Ljava/util/ArrayList;

    invoke-static {v0}, Lcom/motorola/android/internal/telephony/QcomNvInfo$QcomSubsidyLockDetail;->isRSUlocked(Ljava/util/ArrayList;)Z

    move-result v0

    iput-boolean v0, v4, Lcom/motorola/android/internal/telephony/QcomNvInfo$QcomSubsidyLockDetail;->isRSU:Z
...
.method private static isRSUlocked(Ljava/util/ArrayList;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 358
    .local p0, "subtypeInfoList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/motorola/android/telephony/MotoExtTelephonyInfo$SubtypeInfo;>;"
    ...
    check-cast v1, Lcom/motorola/android/telephony/MotoExtTelephonyInfo$SubtypeInfo;

    .line 359
    .local v1, "si":Lcom/motorola/android/telephony/MotoExtTelephonyInfo$SubtypeInfo;
    iget-boolean v2, v1, Lcom/motorola/android/telephony/MotoExtTelephonyInfo$SubtypeInfo;->isLocked:Z

    if-eqz v2, :cond_0

    iget v2, v1, Lcom/motorola/android/telephony/MotoExtTelephonyInfo$SubtypeInfo;->maxTryNum:I
    ...
    .line 362
    .end local v1    # "si":Lcom/motorola/android/telephony/MotoExtTelephonyInfo$SubtypeInfo;
    :cond_0
    goto :goto_0
